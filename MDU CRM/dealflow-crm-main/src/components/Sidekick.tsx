...
const SELLER_PROMPTS = [
  'Hva er neste steg i denne dealen?',
  'Skriv en oppfølgings-e-post',
  'Hvordan håndterer jeg prisinnvending?',
...
export function Sidekick({ mode = 'seller', context = {} }: SidekickProps) {
        ...
        >
              ...
              <div className="h-full flex flex-col justify-between">
                <div className="text-center pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {mode === 'seller'
                      ? 'Hei! Jeg er her for å hjelpe deg med MDU-salg.'
                      : 'Hei! Jeg hjelper deg med pipeline og team-analyse.'}
                  </p>
                </div>
                <div className="grid grid-cols-1 gap-2 pb-2">
                  {SELLER_PROMPTS.map((prompt) => (
                    <button
                      key={prompt}
          ...
          <div className="shrink-0 border-t border-border px-3 py-2 flex items-end gap-2 bg-background">
            <textarea
              ...
              placeholder="Spør meg om dealen..."
              rows={1}
