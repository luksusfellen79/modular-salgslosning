...
// OFFER_SF_OPPORTUNITIES fjernet — opportunities hentes fra mockData

export const OFFER_MOCK_OFFERS: Offer[] = [
  { id: 'offer-001', customerId: 'cust-001', customerName: 'Parkveien Borettslag', customerEmail: 'erik.andersen@parkveien.no', customerOrg: 'Parkveien Borettslag SA', packageId: 'pkg-m', selectedProducts: ['tv-basis', 'stream-netflix', 'bb-500', 'sec-nettvern', 'hw-router-std'], totalPoints: 240, monthlyPrice: 449, discountPercent: 10, validUntil: '2026-03-31', salesRepName: 'Anna Kristiansen', salesforceOpportunityId: 'sf-001', notes: 'Styreleder ønsker presentasjon for beboere i februar.', status: 'sent', createdAt: '2026-02-10' },
  { id: 'offer-002', customerId: 'cust-002', customerName: 'Fjordheim Sameie', customerEmail: 'marte.olsen@fjordheim.no', customerOrg: 'Fjordheim Sameie', packageId: 'pkg-l', selectedProducts: ['tv-basis', 'stream-netflix', 'stream-viaplay', 'bb-500', 'sec-nettvern', 'hw-router-std'], totalPoints: 280, monthlyPrice: 539, discountPercent: 10, validUntil: '2026-04-15', salesRepName: 'Anna Kristiansen', salesforceOpportunityId: 'sf-002', notes: 'Ønsker demo av T-We TV-løsning.', status: 'viewed', createdAt: '2026-02-12' },
  { id: 'offer-003', customerId: 'cust-003', customerName: 'Solsiden Borettslag', customerEmail: 'lars.berg@solsiden.no', customerOrg: 'Solsiden Borettslag BA', packageId: 'pkg-xl', selectedProducts: ['tv-basis', 'tv-sport', 'stream-netflix', 'stream-hbo', 'bb-1000', 'sec-nettvern', 'sec-plus', 'hw-router-pro'], totalPoints: 380, monthlyPrice: 629, discountPercent: 10, validUntil: '2026-05-01', salesRepName: 'Jonas Mikkelsen', salesforceOpportunityId: 'sf-003', status: 'accepted', createdAt: '2026-02-05' },
  { id: 'offer-004', customerId: 'cust-004', customerName: 'Berglia Borettslag', customerEmail: 'kari.haugen@berglia.no', customerOrg: 'Berglia Borettslag SA', packageId: 'pkg-s', selectedProducts: ['bb-1000', 'sec-nettvern', 'hw-router-std'], totalPoints: 200, monthlyPrice: 359, discountPercent: 10, validUntil: '2026-03-15', salesRepName: 'Jonas Mikkelsen', status: 'declined', createdAt: '2026-01-28' },
  { id: 'offer-005', customerId: 'cust-005', customerName: 'Torget Sameie', customerEmail: 'ole.strand@torget.no', customerOrg: 'Torget Sameie', packageId: 'pkg-m', selectedProducts: ['tv-basis', 'stream-netflix', 'bb-250', 'sec-nettvern', 'hw-router-std'], totalPoints: 220, monthlyPrice: 449, discountPercent: 5, validUntil: '2026-04-01', salesRepName: 'Anna Kristiansen', status: 'draft', createdAt: '2026-02-18' },
  { id: 'offer-006', customerId: 'cust-006', customerName: 'Havnekanten Borettslag', customerEmail: 'sigrid.dahl@havnekanten.no', customerOrg: 'Havnekanten Borettslag SA', packageId: 'pkg-l', selectedProducts: ['tv-basis', 'stream-netflix', 'stream-viaplay', 'bb-1000', 'sec-nettvern', 'hw-router-pro'], totalPoints: 310, monthlyPrice: 539, discountPercent: 15, validUntil: '2026-04-30', salesRepName: 'Jonas Mikkelsen', status: 'accepted', createdAt: '2026-02-01' },
];
