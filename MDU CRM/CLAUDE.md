...
### `src/pages/Quiz.jsx`
- Demo-spørsmål hardkodet (skal erstattes med DB/AI-genererte)
...
| `VITE_SUPABASE_ANON_KEY` | Supabase anon/public nøkkel (JWT) |

Lokalt: `.env.local` (ikke committed til git)
Produksjon: Satt i Vercel dashboard
...
### Høy prioritet
- [ ] **AI-genererte quiz-spørsmål** – Supabase Edge Function som kaller Anthropic API med venue-navn som input, lagrer til `quiz_questions`
- [ ] **Veto-system** – UI for å bruke veto på neste foreslåtte bar, telle brukte veto
- [ ] **Quiz fra database** – Quiz.jsx bruker hardkodede spørsmål, skal hente fra `quiz_questions` basert på venue_id
...
- `Quiz.jsx` bruker hardkodede demo-spørsmål, ikke koblet til databasen ennå
